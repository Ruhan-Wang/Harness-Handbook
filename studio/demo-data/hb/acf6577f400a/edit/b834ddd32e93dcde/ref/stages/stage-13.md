...
- `reg-installation-identity` — The stable local identity for this app install, used to recognize this installation across runs.
...
- `reg-input-queues-and-mailboxes` — The buffered user inputs, steering commands, and inter-agent messages waiting to be handled.
