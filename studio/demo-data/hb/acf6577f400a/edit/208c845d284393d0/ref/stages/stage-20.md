...
- `reg-installation-identity` — The stable ID for this installed copy of the app, used across account, request metadata, and analytics flows.
...
- `reg-db-recovery-state` — The shared record of detected database corruption and the backup-and-rebuild actions taken to recover safely.
